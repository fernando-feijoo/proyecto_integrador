...
<body class="d-flex justify-content-center align-items-center vh-100">
    <div id="contenedor-login" class="p-5 rounded-5 text-secondary shadow" style="width: 40rem">
        ...
        <div class="d-flex justify-content-around mt-1">
            ...
            <div class="pt-1">
                <a href="#" class="text-decoration-none text-info fw-semibold fst-italic" style="font-size: 0.9rem; color: #262626 !important">¿Olvidó su contraseña?</a>
            </div>
        </div>

        <a href="dashboard.html"><input id="boton-inicio" class="btn text-white fs-5 w-100 mt-4 fw-semibold shadow-sm rounded-4" type="button" value="Iniciar Sesión"></a>
