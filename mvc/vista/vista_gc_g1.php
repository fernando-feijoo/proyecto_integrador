...
<div class="row">
    ...
    <div class="defectos d-flex">
        <div class="c-f1">
        <h6 class="p-1">-36</h6>
        <input class="pi" type="number" placeholder="0" style="width: 40px; margin-top: 5px;">
        </div>
        <div class="c-f2">
        <h6 class="p-1">37</h6>
        <input class="pi" type="number" placeholder="0" style="width: 40px; margin-top: 5px;">
    ...
    border-bottom-right-radius : 15px; margin-bottom: 10px; padding: 20px;" >
        ...
        <input class = "tot" type="text" placeholder="0" style="width: 50px; margin-top: 5px;" disabled>
        </div>
    </div>
    </div>
...
<div class="row">
    ...
    <div class="defectos d-flex">
        <div class="c1-f2">
        <h6 class="p-1">-36</h6>
        <input class="pi" type="number" placeholder="0" style="width: 40px; margin-top: 5px;" disabled>
        </div>
        <div class="c2-f2">
        <h6 class="p-1">37</h6>
        <input class="pi" type="number" placeholder="0" style="width: 40px; margin-top: 5px;" disabled>
...
<div class="d-flex flex-row justify-content-end">
                        <div class="p-2">
                            ...
                            <button id="boton-guardar_gc" class="btn btn-outline-info" type="submit" name="guardar_gc"
