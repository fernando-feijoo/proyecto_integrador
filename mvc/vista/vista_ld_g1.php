...
<?php
if (($validacion = cargar_ld1()) != false and ($validacion2 = cargar_ld2()) != false) {
  $sql_ld1 = cargar_ld1();
  $sql_ld2 = cargar_ld2();
  while ($fila1 = $sql_ld1->fetch_object() and $fila2 = $sql_ld2->fetch_object()) {
  ?>
                                ...
                                <div class="fila-1-678 d-flex" style="margin-top: 20px">
                                        <div class="ld-sup-6">
                                                ...
                                                <div class="cm-2">
                                                        ...
                                                        <input class="cm" type="number" value="<?= $fila1->ld1?>"
                                                                style="width: 37px;" name="cm-6-0" id="cm-6-0">
                                                        <input class="cm" type="number" value="<?= $fila1->ld2?>"
                                                                style="width: 37px;" name="cm-6-2" id="cm-6-2">
                                                        <input class="cm" type="number" value="<?= $fila1->ld3?>"
                                                                style="width: 37px;" name="cm-6-4" id="cm-6-4">
                                                        <input class="cm" type="number" value="<?= $fila1->ld4?>"
                                                                style="width: 37px;" name="cm-6-6" id="cm-6-6">
                                                        <input class="cm" type="number" value="<?= $fila1->ld5?>"
                                        ...
                                        <div class="ld-sup-7" style="margin-left: 5px">
                                                ...
                                                <div class="cm-2">
                                                        ...
                                                        <input class="cm" type="number" value="<?= $fila1->ld6?>"
                                                                style="width: 37px;" name="cm-7-0" id="cm-7-0">
                                                        <input class="cm" type="number" value="<?= $fila1->ld7?>"
                                                                style="width: 37px;" name="cm-7-2" id="cm-7-2">
                                                        <input class="cm" type="number" value="<?= $fila1->ld8?>"
                                                                style="width: 37px;" name="cm-7-4" id="cm-7-4">
                                                        <input class="cm" type="number" value="<?= $fila1->ld9?>"
                                                                style="width: 37px;" name="cm-7-6" id="cm-7-6">
                                                        <input class="cm" type="number" value="<?= $fila1->ld10?>"
                                        ...
                                        <div class="ld-sup-8" style="margin-left: 5px">
                                                ...
                                                <div class="cm-2">
                                                        ...
                                                        <input class="cm" type="number" value="<?= $fila1->ld11?>"
                                                                style="width: 37px;" name="cm-8-0" id="cm-8-0">
                                                        <input class="cm" type="number" value="<?= $fila1->ld12?>"
                                                                style="width: 37px;" name="cm-8-2" id="cm-8-2">
                                                        <input class="cm" type="number" value="<?= $fila1->ld13?>"
                                                                style="width: 37px;" name="cm-8-4" id="cm-8-4">
                                                        <input class="cm" type="number" value="<?= $fila1->ld14?>"
                                                                style="width: 37px;" name="cm-8-6" id="cm-8-6">
                                                        <input class="cm" type="number" value="<?= $fila1->ld15?>"
                                        ...
                                        <div class="ld-sup-9" style="margin-left: 5px">
                                                ...
                                                <div class="cm-2">
                                                        <input class="cm" type="number" value="<?= $fila1->ld16?>"
                                                                style="width: 37px;" name="cm-9-0" id="cm-9-0">
                                                        <input class="cm" type="number" value="<?= $fila1->ld17?>"
                                                                style="width: 37px;" name="cm-9-2" id="cm-9-2">
                                                        <input class="cm" type="number" value="<?= $fila1->ld18?>"
                                                                style="width: 37px;" name="cm-9-4" id="cm-9-4">
                                                        <input class="cm" type="number" value="<?= $fila1->ld19?>"
                                                                style="width: 37px;" name="cm-9-6" id="cm-9-6">
                                                        <input class="cm" type="number" value="<?= $fila1->ld20?>"
                                        ...
                                        <div class="ld-sup-10" style="margin-left: 5px">
                                                ...
                                                <div class="cm-2">
                                                        <input class="cm" type="number" value="<?= $fila1->ld21?>"
                                                                style="width: 37px;" name="cm-10-0" id="cm-10-0">
                                                        <input class="cm" type="number" value="<?= $fila1->ld22?>"
                                                                style="width: 37px;" name="cm-10-2" id="cm-10-2">
                                                        <input class="cm" type="number" value="<?= $fila1->ld23?>"
                                                                style="width: 37px;" name="cm-10-4" id="cm-10-4">
                                                        <input class="cm" type="number" value="<?= $fila1->ld24?>"
                                                                style="width: 37px;" name="cm-10-6" id="cm-10-6">
                                                        <input class="cm" type="number" value="<?= $fila1->ld25?>"
                                        ...
                                        <div class="ld-sup-11" style="margin-left: 5px">
                                                ...
                                                <div class="cm-2">
                                                        <input class="cm" type="number" value="<?= $fila1->ld26?>"
                                                                style="width: 37px;" name="cm-11-0" id="cm-11-0">
                                                        <input class="cm" type="number" value="<?= $fila1->ld27?>"
                                                                style="width: 37px;" name="cm-11-2" id="cm-11-2">
                                                        <input class="cm" type="number" value="<?= $fila1->ld28?>"
                                                                style="width: 37px;" name="cm-11-4" id="cm-11-4">
                                                        <input class="cm" type="number" value="<?= $fila1->ld29?>"
                                                                style="width: 37px;" name="cm-11-6" id="cm-11-6">
                                                        <input class="cm" type="number" value="<?= $fila1->ld30?>"
                                ...
                                <div class="total-boton d-flex">
                                        <div class="total-f1">
                                                <div class="c-total"
                                                        ...
                                                        <input class="total-sup" type="text" value="<?= $fila1->total_largo_dedo?>"
                ...
                <div class="ld-f2">
                        <div class="fila-1-678 d-flex" style="margin-top: 20px">
                                <div class="ld-sup-6">
                                        ...
                                        <div class="cm-2">
                                                <input class="cm" type="text" value="<?= $fila2->ld1?>" style="width: 37px;"
                                                        name="cm-6-0-inf" id="cm-6-0-inf" readonly>
                                                <input class="cm" type="text" value="<?= $fila2->ld2?>" style="width: 37px;"
                                                        name="cm-6-2-inf" id="cm-6-2-inf" readonly>
                                                <input class="cm" type="text" value="<?= $fila2->ld3?>" style="width: 37px;"
                                                        name="cm-6-4-inf" id="cm-6-4-inf" readonly>
                                                <input class="cm" type="text" value="<?= $fila2->ld4?>" style="width: 37px;"
                                                        name="cm-6-6-inf" id="cm-6-6-inf" readonly>
                                                <input class="cm" type="text" value="<?= $fila2->ld5?>" name="cm-6-8-inf"
                                ...
                                <div class="ld-sup-7" style="margin-left: 5px">
                                        ...
                                        <div class="cm-2">
                                                <input class="cm" type="text" value="<?= $fila2->ld6?>" style="width: 37px;"
                                                        name="cm-7-0-inf" id="cm-7-0-inf" readonly>
                                                <input class="cm" type="text" value="<?= $fila2->ld7?>" style="width: 37px;"
                                                        name="cm-7-2-inf" id="cm-7-2-inf" readonly>
                                                <input class="cm" type="text" value="<?= $fila2->ld8?>" style="width: 37px;"
                                                        name="cm-7-4-inf" id="cm-7-4-inf" readonly>
                                                <input class="cm" type="text" value="<?= $fila2->ld9?>" style="width: 37px;"
                                                        name="cm-7-6-inf" id="cm-7-6-inf" readonly>
                                                <input class="cm" type="text" value="<?= $fila2->ld10?>" style="width: 37px;"
                                                        name="cm-7-8-inf" id="cm-7-8-inf" readonly>
                                        </div>
                                ...
                                <div class="ld-sup-8" style="margin-left: 5px">
                                        <h6 class="ld-sup">8</h6>
                                        <div class="med-cm">
                                                <h6 class="ld-med" style="margin-left: 15px"> </h6>
                                                <h6 class="ld-med" style="margin-left: 28px">2</h6>
                                                <h6 class="ld-med" style="margin-left: 25px">4</h6>
                                                <h6 class="ld-med" style="margin-left: 28px">6</h6>
                                                <h6 class="ld-med" style="margin-left: 28px">8</h6>
                                        ...
                                        <div class="cm-2">
                                                <input class="cm" type="text" value="<?= $fila2->ld11?>" style="width: 37px;"
                                                        name="cm-8-0-inf" id="cm-8-0-inf" readonly>
                                                <input class="cm" type="text" value="<?= $fila2->ld12?>" style="width: 37px;"
                                                        name="cm-8-2-inf" id="cm-8-2-inf" readonly>
                                                <input class="cm" type="text" value="<?= $fila2->ld13?>" style="width: 37px;"
                                                        name="cm-8-4-inf" id="cm-8-4-inf" readonly>
                                                <input class="cm" type="text" value="<?= $fila2->ld14?>" style="width: 37px;"
                                                        name="cm-8-6-inf" id="cm-8-6-inf" readonly>
                                                <input class="cm" type="text" value="<?= $fila2->ld15?>" style="width: 37px;"
                                                        name="cm-8-8-inf" id="cm-8-8-inf" readonly>
                                        </div>
                                ...
                                <div class="ld-sup-9" style="margin-left: 5px">
                                        ...
                                        <div class="cm-2">
                                                <input class="cm" type="text" value="<?= $fila2->ld16?>" style="width: 37px;"
                                                        name="cm-9-0-inf" id="cm-9-0-inf" readonly>
                                                <input class="cm" type="text" value="<?= $fila2->ld17?>" style="width: 37px;"
                                                        name="cm-9-2-inf" id="cm-9-2-inf" readonly>
                                                <input class="cm" type="text" value="<?= $fila2->ld18?>" style="width: 37px;"
                                                        name="cm-9-4-inf" id="cm-9-4-inf" readonly>
                                                <input class="cm" type="text" value="<?= $fila2->ld19?>" style="width: 37px;"
                                                        name="cm-9-6-inf" id="cm-9-6-inf" readonly>
                                                <input class="cm" type="text" value="<?= $fila2->ld20?>" style="width: 37px;"
                                                        name="cm-9-8-inf" id="cm-9-8-inf" readonly>
                                        </div>
                                ...
                                <div class="ld-sup-10" style="margin-left: 5px">
                                        ...
                                        <div class="cm-2">
                                                <input class="cm" type="text" value="<?= $fila2->ld21?>" style="width: 37px;"
                                                        name="cm-10-0-inf" id="cm-10-0-inf" readonly>
                                                <input class="cm" type="text" value="<?= $fila2->ld22?>" style="width: 37px;"
                                                        name="cm-10-2-inf" id="cm-10-2-inf" readonly>
                                                <input class="cm" type="text" value="<?= $fila2->ld23?>" style="width: 37px;"
                                                        name="cm-10-4-inf" id="cm-10-4-inf" readonly>
                                                <input class="cm" type="text" value="<?= $fila2->ld24?>" style="width: 37px;"
                                                        name="cm-10-6-inf" id="cm-10-6-inf" readonly>
                                                <input class="cm" type="text" value="<?= $fila2->ld25?>" style="width: 37px;"
                                                        name="cm-10-8-inf" id="cm-10-8-inf" readonly>
                                        </div>
                                ...
                                <div class="ld-sup-11" style="margin-left: 5px">
                                        ...
                                        <div class="cm-2">
                                                <input class="cm" type="text" value="<?= $fila2->ld26?>" style="width: 37px;"
                                                        name="cm-11-0-inf" id="cm-11-0-inf" readonly>
                                                <input class="cm" type="text" value="<?= $fila2->ld27?>" style="width: 37px;"
                                                        name="cm-11-2-inf" id="cm-11-2-inf" readonly>
                                                <input class="cm" type="text" value="<?= $fila2->ld28?>" style="width: 37px;"
                                                        name="cm-11-4-inf" id="cm-11-4-inf" readonly>
                                                <input class="cm" type="text" value="<?= $fila2->ld29?>" style="width: 37px;"
                                                        name="cm-11-6-inf" id="cm-11-6-inf" readonly>
                                                <input class="cm" type="text" value="<?= $fila2->ld30?>" style="width: 37px;"
                                                        name="cm-11-8-inf" id="cm-11-8-inf" readonly>
                                        </div>
                                </div>
                                ...
                                <div class="c-total"
                                        ...
                                        <div class="f2-total">
                                                ...
                                                <div class="inp-total-2">
                                                        <input class="total-inf" type="text" value="<?= $fila2->total_largo_dedo_op?>"
                                                                style="width: 200px;" name="total-inf" id="total-inf"
                                                                readonly>
                                                </div>
                                        </div>
                                </div>
                                <div class="c-promedio"
                                        ...
                                        <div class="f2-promedio">
                                                ...
                                                <div class="inp-prom-2">
                                                        <input class="promedio-ld" type="text" value="<?= $fila2->promedio?>"
                                                                style="width: 200px;" name="promedio-ld"
                                                                id="promedio-ld" readonly>
                                                </div>
                                        </div>
                                </div>
                        </div>
                                ...
                                <div class="fila-1-678 d-flex" style="margin-top: 20px">
                                        <div class="ld-sup-6">
                                                ...
                                                <div class="cm-2">
                                                        ...
                                                        <input class="cm" type="number" placeholder=" "
                                                                style="width: 37px;" name="cm-6-0" id="cm-6-0">
                                                        <input class="cm" type="number" placeholder=" "
                                                                style="width: 37px;" name="cm-6-2" id="cm-6-2">
                                                        <input class="cm" type="number" placeholder=" "
                                ...
                                <div class="total-boton d-flex">
                                        <div class="total-f1">
                                                <div class="c-total"
                                                        style="margin-left: 500px; margin-top: 20px; width: 200px;  margin-bottom: 20px;">
                                                        <h6 class="total-1" style="background-color: white;">Total</h6>
                                                        <input class="total-sup" type="text" placeholder=" "
                                                                style="width: 200px;" name="total-sup" id="total-sup"
                                                                readonly>
                                                </div>
                                        </div>
                ...
                <div class="ld-f2">
                        <div class="fila-1-678 d-flex" style="margin-top: 20px">
                                <div class="ld-sup-6">
                                        ...
                                        <div class="cm-2">
                                                <input class="cm" type="text" placeholder=" " style="width: 37px;"
                                                        name="cm-6-0-inf" id="cm-6-0-inf" readonly>
                                                <input class="cm" type="text" placeholder=" " style="width: 37px;"
                                                        name="cm-6-2-inf" id="cm-6-2-inf" readonly>
                                                <input class="cm" type="text" placeholder=" " style="width: 37px;"
                                                ...
                                                <input class="cm" type="text" placeholder=" " style="width: 37px;"
                                                        name="cm-6-6-inf" id="cm-6-6-inf" readonly>
                                                <input class="cm" type="text" placeholder=" " name="cm-6-8-inf"
                                                        id="cm-6-8-inf" style="width: 37px; margin-right: 4px;"
                                                        readonly>
                                        </div>
                        ...
                        <div class="total-prom-f2 d-flex">
                                <div class="c-total"
                                        ...
                                        <div class="f2-total">
                                                ...
                                                <div class="inp-total-2">
                                                        <input class="total-inf" type="text" placeholder=" "
                                                                style="width: 200px;" name="total-inf" id="total-inf"
                                                                readonly>
                                                </div>
                                        </div>
                                ...
                                <div class="c-promedio"
                                        ...
                                        <div class="f2-promedio">
                                                ...
                                                <div class="inp-prom-2">
                                                        <input class="promedio-ld" type="text" placeholder=" "
                                                                style="width: 200px;" name="promedio-ld"
                                                                id="promedio-ld" readonly>
                                                </div>
                                        </div>
