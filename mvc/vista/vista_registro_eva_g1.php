    ...
    <nav>
      <div class="nav nav-tabs" id="nav-tab" role="tablist">
        ...
        <button class="nav-link" id="nav-gc-tab" data-bs-toggle="tab" data-bs-target="#nav-gc" type="button" role="tab"
          aria-controls="nav-gc" aria-selected="false">Grado Calibre</button>
        <button class="nav-link" id="nav-ld-tab" data-bs-toggle="tab" data-bs-target="#nav-ld" type="button" role="tab"
          aria-controls="nav-ld" aria-selected="false">Largo Dedo</button>
        <button class="nav-link" id="nav-asepsias-tab" data-bs-toggle="tab" data-bs-target="#nav-asepsias" type="button"
          role="tab" aria-controls="nav-asepsias" aria-selected="false">Asepcias</button>
        <button class="nav-link" id="nav-se-tab" data-bs-toggle="tab" data-bs-target="#nav-se" type="button" role="tab"
          aria-controls="nav-se" aria-selected="false">Seleccion Empaque</button>
    ...
    <form action="./vista_registro_eva_g1.php" method="post">
      ...
      <div class="tab-content" id="nav-tabContent">
        ...
        <div class="tab-pane fade show active" id="nav-dg" role="tabpanel" aria-labelledby="nav-dg-tab">
          <?php
          include("./vista_detalles_generales_g1.php"); ?>
        </div>

        <div class="tab-pane fade" id="nav-gc" role="tabpanel" aria-labelledby="nav-gc-tab">
          <?php
          include("./vista_gc_g1.php") ?>
        </div>

        <div class="tab-pane fade" id="nav-ld" role="tabpanel" aria-labelledby="nav-ld-tab">
          <?php
          include("./vista_ld_g1.php") ?>
        </div>
