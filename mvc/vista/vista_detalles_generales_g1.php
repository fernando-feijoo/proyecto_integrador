    ...
    <form action="./vista_registro_eva_g1.php" method="post">
                    ...
                    <div class="col-6">
                        ...
                        <div class="p-2 left">FINCA
                            <input class="inp_f text-uppercase" type="text" placeholder="FINCA"
                                style="height: 30px; width: 360px;" value="<?= $carga_datos->finca ?>" name="finca">
                        </div>
                    </div>
                    <div class="col-6">
                    ...
                    <div class="eva left">
                        ...
                        <div class="f1 mt3">
                            ...
                            <input class="text-uppercase" type="time" style="height: 30px;"
                                value="<?= $carga_datos->hora_eva ?>" name="hora">
                            SEMANA
        ...
        <div class="d-flex flex-row justify-content-end ms-auto me-5 mb-1 mt-0">
                    <div class="p-2">
                        ...
                        if (empty($_GET["id_eva"])) {
                        ?>
                            <button id="boton-guardar-eva" class="btn btn-outline-primary" type="submit" name="guardar_eva" value="guardado">Guardar</button>
                        <?php
                        } else {
                        ?>
                            <button id="boton-actualizar-eva" class="btn btn-outline-info" type="submit" name="actualizar_eva" value="actualizado">Actualizar</button>
                        <?php
                        }
                        ?>
                    </div>
