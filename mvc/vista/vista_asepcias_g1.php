...
<div class="d-flex flex-row justify-content-end">
  <button id="boton-guardar_gc" class="btn btn-outline-info d-f mt-2" type="submit" name="guardar_asepcias"
    value="actualizado" style="margin-left: 265px;">Guardar</button>
</div>
